              ...
              <div className="col-lg-9 order-lg-last order-1 tab-content">
                ...
                >
                  <div className="dashboard-content">
                    <p>
                      Hello <strong className="text-dark">{user}</strong> (not
                      <strong className="text-dark"> {user}</strong>?
                      <a href="#" className="btn btn-link " onClick={logOut}>
                        Log out
                      </a>
                      )
                    </p>
                      ...
                      <div className="col-6 col-md-4">
                        <div className="feature-box text-center pb-4">
                          <a href="#order" className="link-to-tab">
                            ...
                            <SlSocialDropbox fontSize={90} color="#f4f4f4" />
                          </a>
                      ...
                      <div className="col-6 col-md-4">
                        <div className="feature-box text-center pb-4">
                          <a href="#address" className="link-to-tab">
                            ...
                            <CiLocationOn fontSize={90} color="#f4f4f4" />
                          </a>
                          <div className="feature-box-content">
                            <h3>ADDRESSES</h3>
                          </div>
                      ...
                      <div className="col-6 col-md-4">
                        <div className="feature-box text-center pb-4">
                          <a href="#" onClick={logOut}>
                            ...
                            <CiLogout fontSize={90} color="#f4f4f4" />
                          </a>
                          <div className="feature-box-content">
                            <h3>LOGOUT</h3>
                          </div>
